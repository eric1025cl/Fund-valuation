...
class ApiTests(unittest.TestCase):
    def test_add_list_estimate_and_delete_fund(self):
        ...
        self.assertEqual(reconciliation_rows.status_code, 200)
        self.assertEqual(reconciliation_rows.json()[0]["code"], "161725")
        self.assertAlmostEqual(reconciliation_rows.json()[0]["abs_growth_error_pct"], 0.1)
